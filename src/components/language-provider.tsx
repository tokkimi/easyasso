...
const translations: Record<string, string> = {
  ...
  'Sous-domaine immédiat, domaine personnalisé seulement quand il est vraiment prêt.': 'Instant subdomain, with the custom domain shown only when it is truly ready.',
