...
const schema = z.object({
  donationCardEnabled: z.boolean().default(false), donationStripeUrl: z.string().url().or(z.literal('')).default(''), donationHelloAssoUrl: z.string().url().or(z.literal('')).default(''),
